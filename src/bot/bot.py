...
from db.core import create_session, change_guardrail
...
def init_dispatcher(agent: SafeAgent) -> Dispatcher:
    ...
    @dp.callback_query(lambda c: c.data in ["disable", "regular_expressions", "machine_learning", "large_language_model"])
